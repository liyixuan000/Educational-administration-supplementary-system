...
<tr>
<td bgcolor="#99CCFF">
<div align="center"><form action="user_save.asp" method="post" name="myform">
<table cellpadding="4" cellspacing="1" class="toptable grid" border="1" width="100%" bordercolor="#FFFFFF">
  <tr>
	...
	<p align="center">新建用户(带*号的为必填项)</td>
  </tr>

  <tr>
    <td height="30" align="right">用户名：</td>
    <td class="category">
        <input name="username" type="text" id="username" style="width:300px">
  ...
  <tr>
    ...
    <td class="category">
        <input name="email" type="text" id="email" style="width:300px"></td>
  </tr>
...
<option value="3">学生</option>
  ...
  <tr>
    ...
    <td class="category"><textarea name="content" rows="6" id="content" style="width:300px"></textarea>
        &nbsp;</td>
  </tr>
  <tr>
    <td height="30">　</td>
