      ...
      <tr>
        <td nowrap="nowrap" height="500" align="center"><table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%" align="center">
          <tr>
            ...
            <td align="center" valign="top" height="600" nowrap="nowrap" bgcolor="#99CCFF"><form action="practice_save.asp?action=Add" method="post" name="myform"onsubmit="return check()">
              <div align="center">
                <table cellspacing="0" cellpadding="0" border="1" width="100%" bordercolor="#FFFFFF">
                  <tr>
                    <td nowrap="nowrap" colspan="2" height="30" align="center" bordercolor="#FFFFFF"> 　
                      <p><b><font size="5" face="华文隶书">公共社会实践项目上传</font></b></p></td>
                  </tr>
                  <tr>
                    <td width="30%"  height="30"  align="center" nowrap="nowrap" bordercolor="#FFFFFF"> 实践名称 </td>
                  ...
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="center" bordercolor="#FFFFFF">实践时间</td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><input type="text" class="text" name="prize" />
                      <span class="category"> &nbsp;<font color="#ff0000">*</font></span></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="center" bordercolor="#FFFFFF">所需人数</td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><input name="title" type="text" class="text" id="title" />
                      <span class="category"> &nbsp;<font color="#ff0000">*</font></span></td>
                  </tr>                  <tr>
                    <td nowrap="nowrap"  height="30"  align="center" bordercolor="#FFFFFF"> 具体内容 </td>
