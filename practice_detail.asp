                ...
                <table cellspacing="0" cellpadding="0" border="1" width="100%" bordercolor="#FFFFFF">
                  <tr>
                    <td nowrap="nowrap" colspan="2" height="30" align="center" bordercolor="#FFFFFF"> 　
                      <p><b><font size="5" face="华文隶书">公共社会实践项目详情</font></b></p></td>
                  </tr>
                  <tr>
                    <td width="30%"  height="30"  align="right" nowrap="nowrap" bordercolor="#FFFFFF">实践名称： </td>
                  ...
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF">所需人数： </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><%=title%></td>
                  </tr>                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF">具体内容： </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><%=content%></td>
                  </tr>
<tr>
  <td nowrap="nowrap"  height="30" align="right" bordercolor="#FFFFFF">上传时间：</td>
