      ...
      <tr>
        <td nowrap="nowrap" height="500" align="center"><table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%" align="center">
          <tr>
            ...
            <td align="center" valign="top" height="600" nowrap="nowrap" bgcolor="#99CCFF"><form action="activitycj_save.asp?action=Add" method="post" name="myform"onsubmit="return check()">
              <div align="center">
                <table cellspacing="0" cellpadding="0" border="1" width="100%" bordercolor="#FFFFFF">
                  <tr>
                    <td nowrap="nowrap" colspan="2" height="30" align="center" bordercolor="#FFFFFF"> 　
                      <p><b><font size="5" face="华文隶书">活动成绩认证申请</font></b></p></td>
                  </tr>
                  <tr>
        ...
        &nbsp;<font color="#ff0000">*</font></span></td>
                  ...
                  <tr>
                    ...
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><input type="text" class="text" name="prize" />
                      <span class="category"> &nbsp;<font color="#ff0000">*</font></span></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap"  height="30" align="center" bordercolor="#FFFFFF"> 项目内排名 </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><input type="text" class="text" name="orders" />
                  ...
                  <tr>
                    ...
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><div class="style2" id=picUrl_display style="display:none;"><input name="picUrl" type="text" id="picUrl" size="50"></div>
				  <iframe src="picUpload2.asp" width=100% height=40 frameborder="0" scrolling="no"></iframe></td>
                  </tr>
                  <tr>
