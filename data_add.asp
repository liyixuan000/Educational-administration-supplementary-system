...
<tr>
<td bgcolor="#99CCFF">
<div align="center"><form action="data_save.asp?action=Add" method="post" name="myform" onSubmit="return check();">
<table cellpadding="4" cellspacing="1" class="toptable grid" border="1" width="100%" bordercolor="#FFFFFF">
  ...
  <tr>
    ...
    <td class="category">
        <select name="pclass_id" id="pclass_id"  ><option value="0">选择形式</option>
        <%
...
-->
  ...
  <tr>
    <td height="30" align="right">资料说明：</td>
