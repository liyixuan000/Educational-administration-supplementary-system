...
{
	  document.write("<input type='text'  name='"+namestr+"' value='"+valuestr+"' size='20' class='wenbenkuang' style='text-align: center;'>&nbsp;<Img src='/images/datetime.gif' style='cursor:hand;' align='absmiddle' alt='弹出日历下拉菜单' onclick='fPopCalendar("+namestr+","+namestr+");return false'>");
}