   function checkClass() 
   {
	  if (document.all.sclass.value == null || document.all.sclass.value == "") 
	    {
          alert("您还没有选择'班级'，请选择'班级'！")
          document.all.sclass.focus();
          window.scrollBy(0,-30);
          return false;
		}
		
	  if (document.all.sname.value == null || document.all.sname.value == "") 
	    {
          alert("您还没有填写'姓名'，请填写'姓名'！")
          document.all.sname.focus();
          return false;
		}
		
	  if (document.all.sno.value == null || document.all.sno.value == "") 
	    {
          alert("您还没有填写'学号'，请填写'学号'！")
          document.all.sno.focus();
          return false;
		}
	
	  if (document.all.sclass.value != null && document.all.sname.value != null && document.all.sno.value != null) 
	    {
              confirm("确认您已经完成试卷，提交后将无法修改！")
            }		
