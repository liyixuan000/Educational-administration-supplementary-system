...
Sub Add()
	...
	rs.close
	set rs = nothing
	Call JsAlertAndGoto_1("温馨提示：添加成功！需要继续添加吗？","activity_Add.asp?lag="&language,"activity_Manage.asp?lag="&language)
End Sub
...
Sub Edit()
	...
	rs.close
	set rs = nothing
	Call JsAlertAndGoto("温馨提示：修改成功！","activity_Manage.asp?&page="&request("page")&"&lag="&request("lag"))
End Sub
