...
<table width="778" border="0" cellpadding="0" bgcolor="#99CCFF">
  ...
  <table width="70%"   border="0" cellpadding="3" cellspacing="1" bgcolor="#B5CDE3">
  <tr>
        <td nowrap height="500" align="center">
            <table cellspacing="0" cellpadding="0" border="0" width="116%" height="100%" align="center">
                <tr>
...
<table cellspacing="0" cellpadding="0" border="1" width="100%" bordercolor="#FFFFFF">
    <tr>
       ...
       　<p><b><font face="华文隶书" size="5">社会实践认证申请</font></b>        </td>
    </tr>
	<tr>
	...
	<tr>
        ...
        实践时间</td>
		<td nowrap bordercolor="#FFFFFF">
        <input type="text" class="text" name="EqProo0"></td>
    </tr>
	<tr>
        <td nowrap  height="30"  align="center" bordercolor="#FFFFFF">
        所需人数 
	...
	<tr>
		...
		<td nowrap bordercolor="#FFFFFF">
        <input type="text" name="T1" size="70"></td>
    </tr>
	<tr>
