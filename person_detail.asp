  ...
  <tr>
    ...
    <td width="567" valign="top"><table width="100%"   border="0" cellpadding="3" cellspacing="1" bgcolor="#B5CDE3">
                ...
                <table cellspacing="0" cellpadding="0" border="1" width="100%" bordercolor="#FFFFFF">
                  <tr>
                    <td nowrap="nowrap" colspan="2" height="30" align="center" bordercolor="#FFFFFF"> 　
                      <p><b><font size="5" face="华文隶书">个人信息发布详情</font></b></p></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" width="30%" bordercolor="#FFFFFF"> 资料类别： </td>
	  ...
	  %></span></td>
                  ...
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF"> 学号： </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><%=bnumber%></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF"> 联系方式： </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><%=prize%></td>
                  </tr>
                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF"> 资料名称： </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><%=title%></td>
                  </tr>                  <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF"> 资料信息简介： </td>
                    <td nowrap="nowrap" bordercolor="#FFFFFF"><%=content%></td>
                  </tr>   <tr>
                    <td nowrap="nowrap"  height="30"  align="right" bordercolor="#FFFFFF"> 发布人： </td>
