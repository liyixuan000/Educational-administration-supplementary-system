...
<BODY>
<%
sql="select * from Eptime_per where id="&request("id")
...
<table align="center" cellpadding="4" cellspacing="1" class="toptable grid" border="1" width="100%">
	  <tr>
        ...
        <td class="category">
          <%
	      sql="select * from Eptime_perClass where id="&rs("id_bigclass")
      ...
      <tr>
        ...
        <td class="category">
          <%
	      sql="select * from Eptime_perxingshi where id="&rs("id_smallclass")
