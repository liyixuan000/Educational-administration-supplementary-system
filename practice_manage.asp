...
<div align="center"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="30" align="left"> 公共社会实践项目 </td>
        <td></td>
      </tr>
  </table>
  <form action="?action=order" method="post" name="myform" target="_self" id="myform" style="margin:0">
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%" align="center" class="table_southidc">
      <tr>
        <td class="back_southidc" height="25" align="center">公共社会实践项目</td>
      </tr>
      <tr>
        <td><table width="100%" height="47"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
          <tr align="center" bgcolor="#EEEEEE">
            <td width="10%" height="24" bgcolor="#EEEEEE">选择</td>
            <td width="20%" bgcolor="#EEEEEE">实践名称</td>
            <td width="13%" bgcolor="#EEEEEE">实践时间</td>
            <td width="15%" bgcolor="#EEEEEE">所需人数</td>
            <td width="17%" bgcolor="#EEEEEE">上传时间</td>
            <td width="15%" bgcolor="#EEEEEE">具体内容</td>
            <%if session("power")=2 then%>
            <td width="25%" bgcolor="#EEEEEE">操作</td>
	  ...
	  %>
          <tr bgcolor="#FFFFFF">
            ...
            <td align="center" bgcolor="#FFFFFF"><%=infotime(rs("addtimes"))%></td><td align="center" bgcolor="#FFFFFF" ><%=rs("content")%></td>
                        <%if session("power")=2 then%>
            <td align="center" bgcolor="#FFFFFF">&nbsp;<a href="practice_edit.asp?id=<%=rs("id")%>&amp;page=<%=request("page")%>">修改</a> <a href="practice_del.asp?id=<%=rs("id")%>" onClick="return checkDel()">删除</a></td>
		...
		call showpage("practice_manage.asp?keyword="&keyword,totalnumber,maxperpage,true,true,"条")
		%></td>
          </tr>
          <%
		else
