...
<form name="form2">
  <tr> 
	...
	<%
	sql="select * from Eptime_wanglai order by id desc"
	set rs_Eptime_wanglai=conn.execute(sql)
	%>&nbsp;&nbsp;&nbsp;
	<%
	...
	<%
	sql="select * from Eptime_yuangong order by id desc"
	set rs_Eptime_yuangong=conn.execute(sql)
	%>&nbsp;&nbsp;&nbsp;
	<%
	sql="select * from Eptime_zhanghu order by id desc"
	set rs_Eptime_zhanghu=conn.execute(sql)
	%>&nbsp;  
...
<td width="100%" background="images/r_0.gif">
  <table cellpadding="0" cellspacing="0" width="100%">
    <tr>
      <td>&nbsp;<a href="excel.asp?mysql=<%=Server.URLEncode(""&sql&"")%>&mytype=a"><img src="images/excel.jpg" border="0" align="absmiddle" alt="导出Excel表格"></td>
    </tr>
  </table>
</td>
